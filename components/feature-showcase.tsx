    ...
    <section className="relative py-24 bg-gradient-to-b from-secondary/10 to-background">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-mono text-foreground mb-4 sm:mb-6 text-balance">
            Superior Technology, Superior Value
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-10">
