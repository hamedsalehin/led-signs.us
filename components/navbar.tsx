    ...
    >
      ...
      <nav className="mx-auto max-w-screen-xl h-full flex items-center justify-between px-3 sm:px-5">
        ...
        <a href="/" className="flex items-center gap-2 shrink-0 mr-2">
          ...
          <span className="hidden xs:inline whitespace-nowrap leading-none">
            <span className="text-base font-extrabold tracking-tight font-mono">
              Nano<span className="text-primary">Signs</span>
            </span>
            {" "}
            <span className="text-[10px] font-medium text-muted-foreground">LED Display</span>
          </span>
        </a>
        ...
        <ul className="hidden lg:flex items-center gap-0.5 flex-1 justify-center">
          {navLinks.map((link) => (
            ...
            >
              <a
                href={link.href}
                className="flex items-center gap-0.5 px-3 py-1.5 text-[15px] font-medium
