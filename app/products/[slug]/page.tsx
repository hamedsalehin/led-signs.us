...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!product) {
    return {
      title: "Product Not Found | Nano Signs",
    }
  }
  return {
    title: `${product.name} | Nano Signs Premium LED Display`,
    description: product.description.length > 155 ? `${product.description.substring(0, 152)}...` : product.description,
    alternates: {
      canonical: `/products/${product.slug}`,
    },
    openGraph: {
      title: `${product.name} | Nano Signs`,
      description: product.description.length > 155 ? `${product.description.substring(0, 152)}...` : product.description,
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-mono tracking-tight text-foreground mb-4 sm:mb-6">
                {product.name}
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed mb-6 sm:mb-8">
                {product.description}
              </p>
